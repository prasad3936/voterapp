...
# (Optionally copy or place sample images into static/photos before running)
# For quick placeholders, you can create simple colored boxes using Pillow,
# but here assume you will add real or placeholder images named 1.jpg..10.jpg
...
# clear existing sample rows for re-run
...
conn.commit()
conn.close()
print("✅ voters.db created with sample data — add 1.jpg..10.jpg into static/photos/")
